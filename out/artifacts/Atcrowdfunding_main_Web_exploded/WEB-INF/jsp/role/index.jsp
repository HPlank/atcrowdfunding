				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<button type="button" class="btn btn-primary"
							style="float: right;" onclick="window.location.href='${APP_PATH}/role/add.html'">
            		...
            		success : function(result){
            			...
            			if(result.success){
            				...
            				$.each(roleList,function(i,n){
								...
								content+="	<td>";
								content+="		<button type='button' onclick='window.location.href=\"${APP_PATH}/role/assignPermission.html?roleid="+n.id+"\"' class='btn btn-success btn-xs'>";
								content+="			<i class=' glyphicon glyphicon-check'></i>";
								content+="		</button>";
								content+="		<button type='button' onclick='window.location.href=\"${APP_PATH}/role/edit.html?pageno="+pageObj.pageno+"&id="+n.id+"\"' class='btn btn-primary btn-xs'>";
